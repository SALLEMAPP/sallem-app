...
public class F2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v1 =  inflater.inflate(R.layout.fragment_f2, container, false);
        Button b = (Button) v1.findViewById(R.id.abBut);
        b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(v1.getContext(), "dfsfsfs", Toast.LENGTH_LONG).show();
            }
        });
